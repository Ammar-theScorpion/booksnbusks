const SearchInput = ({ value, setValue }) => {
    return (
        ...
        <div className="relative h-full w-96 bg-gray-100 rounded-lg shadow-md  ">
            ...
            <input type="search" id="search-dropdown" value={value} onChange={(e) => setValue(e.target.value)} className="block w-full py-2 h-full pl-10 pr-4 text-sm text-gray-900 border  rounded-lg bg-white focus:outline-none focus:ring-2  focus:ring-primary-800 focus:border-primary-800" placeholder="Search..." required />
        </div>
