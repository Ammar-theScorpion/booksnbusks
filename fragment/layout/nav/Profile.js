...
const Notifications = () => {
   ...
   return (
        <div className="relative mr-4" ref={ref}>
            <div className="relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] border-stroke bg-gray hover:text-primary dark:border-strokedark dark:bg-meta-4 dark:text-white p-2" role={"button"} onClick={() => setShow(!show)}>
                ...
                <svg className="fill-current duration-300 ease-in-out hover:text-blue-400" width={18} height={18} viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
